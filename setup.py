...
def main():
    ...
    setup(name='indra',
          ...
          packages=['indra', 'indra.assemblers', 'indra.assemblers.cag',
                    ...
                    'indra.sources.tees', 'indra.sources.isi',
                    'indra.sources.trips', 'indra.sources.trrust',
                    'indra.resources',
                    'indra.resources.famplex', 'indra.statements',
                    'indra.tests', 'indra.tests.test_obo_clients',
                    'indra.tools', 'indra.tools.reading', 'indra.tools.reading.readers',
                    'indra.tools.reading.readers.isi', 'indra.tools.reading.readers.reach',
                    'indra.tools.reading.readers.sparser', 'indra.tools.reading.readers.trips',
