...
latex_documents = [
  (master_doc, 'indra_db.tex', u'INDRA Database Documentation',
   u'P. A. Greene, J. A. Bachman, B. M. Gyori', 'manual'),
]
...
man_pages = [
    (master_doc, 'INDRA DB', u'INDRA Database Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'INDRA DB', u'INDRA Database Documentation',
   author, 'INDRA DB', 'Integrated Network and Dynamical Reasoning Assembler Database.',
   'Miscellaneous'),
]
...
MOCK_MODULES = [
    'flask', 'networkx.drawing.nx_agraph',
    ...
    'sqlalchemy.sql', 'sqlalchemy.sql.expression', 'networkx.algorithms.isomorphism.vf2userfunc',
