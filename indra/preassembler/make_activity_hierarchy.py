...
if __name__ == '__main__':
    ...
    g.add((en.term('RasGef'), has_name, Literal('rasgef')))
    g.add((en.term('RasGap'), has_name, Literal('rasgap')))
    ...
    g.add((en.term('RasGef'), isa, en.term('Catalytic')))
    g.add((en.term('RasGap'), isa, en.term('Catalytic')))
