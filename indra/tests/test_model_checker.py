...
def test_one_step_phosphorylation():
    ...
    # Add annotations
    Annotation(A, 'https://identifiers.org/hgnc/HGNC:1')
    Annotation(B, 'https://identifiers.org/hgnc/HGNC:2')
...
def test_consumption_rule():
    ...
    Rule('DUSP_dephos_MAPK1_at_T185',
         ...
         Parameter('k5', 1))
    Annotation(Pervanadate, 'https://identifiers.org/hgnc/HGNC:1')
    Annotation(MAPK1, 'https://identifiers.org/hgnc/HGNC:2')
...
def test_distinguish_path_polarity1():
    ...
    Annotation(A, 'https://identifiers.org/hgnc/HGNC:1')
    Annotation(B, 'https://identifiers.org/hgnc/HGNC:2')
    Annotation(C, 'https://identifiers.org/hgnc/HGNC:3')
