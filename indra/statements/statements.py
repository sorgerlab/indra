...
class Statement(object):
    ...
    def to_json(self, use_sbo=False, matches_fun=None):
        ...
        if use_sbo:
            ...
            json_dict['sbo'] = \
                'https://identifiers.org/sbo/SBO:%s' % sbo_term
        return json_dict
    ...
    def to_json(self, use_sbo=False, matches_fun=None):
        ...
        if self.enz is not None:
            ...
            if use_sbo:
                # enzymatic catalyst
                json_dict['enz']['sbo'] = \
                    'https://identifiers.org/sbo/SBO:0000460'
        if self.sub is not None:
            json_dict['sub'] = self.sub.to_json()
            if use_sbo:
                # substrate
                json_dict['sub']['sbo'] = \
                    'https://identifiers.org/sbo/SBO:0000015'
        ...
        if self.subj is not None:
            ...
            if use_sbo:
                if self.is_activation:
                    json_dict['subj']['sbo'] = \
                        'https://identifiers.org/sbo/SBO:0000459'  # stimulator
                else:
                    json_dict['subj']['sbo'] = \
                        'https://identifiers.org/sbo/SBO:0000020'  # inhibitor
        if self.obj is not None:
            json_dict['obj'] = self.obj.to_json()
            if use_sbo:
                if self.is_activation:
                    json_dict['obj']['sbo'] = \
                        'https://identifiers.org/sbo/SBO:0000643'  # stimulated
                else:
                    json_dict['obj']['sbo'] = \
                        'https://identifiers.org/sbo/SBO:0000642'  # inhibited
...
class ActiveForm(Statement):
    ...
    def to_json(self, use_sbo=False, matches_fun=None):
        ...
        if use_sbo:
            json_dict['agent']['sbo'] = \
                'https://identifiers.org/sbo/SBO:0000644'  # modified
        json_dict.update(generic)
        return json_dict
...
class Gef(Statement):
    ...
    def to_json(self, use_sbo=False, matches_fun=None):
        ...
        if self.gef is not None:
            ...
            if use_sbo:
                json_dict['gef']['sbo'] = \
                    'https://identifiers.org/sbo/SBO:0000013'  # catalyst
        if self.ras is not None:
            json_dict['ras'] = self.ras.to_json()
            if use_sbo:
                json_dict['ras']['sbo'] = \
                    'https://identifiers.org/sbo/SBO:0000015'  # substrate
        json_dict.update(generic)
        return json_dict
    ...
    def to_json(self, use_sbo=False, matches_fun=None):
        ...
        if self.obj is not None:
            ...
            if use_sbo:
                if isinstance(self, IncreaseAmount):
                    json_dict['obj']['sbo'] = \
                        'https://identifiers.org/sbo/SBO:0000011'  # product
                else:
                    json_dict['obj']['sbo'] = \
                        'https://identifiers.org/sbo/SBO:0000010'  # reactant
        json_dict.update(generic)
        return json_dict
