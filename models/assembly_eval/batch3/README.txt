...
- combined_strict/ - this folder contains the output of assembly based on combined reader outputs
                     but only retaining findings for which there is at least partial support
                     from both readers
