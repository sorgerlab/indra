...
Observable('atm_active', ATM(activity='active'))

Rule(u'ATM_activates_ATM_activity_2', ATM(activity=u'active') + ATM(activity=u'inactive') >> ATM(activity=u'active') + ATM(activity=u'active'), kf_aa_act_1)
Rule(u'ATM_activates_TP53_activity_2', ATM(activity=u'active') + TP53(activity=u'inactive') >> ATM(activity=u'active') + TP53(activity=u'active'), kf_at_act_1)
Rule(u'TP53_activates_PPM1D_activity_3', TP53(activity=u'active') + PPM1D(activity=u'inactive') >> TP53(activity=u'active') + PPM1D(activity=u'active'), kf_tp_act_1)
Rule(u'TP53_activates_MDM2_activity_3', TP53(activity=u'active') + MDM2(activity=u'inactive') >> TP53(activity=u'active') + MDM2(activity=u'active'), kf_tm_act_1)
...
Rule(u'PPM1D_deactivates_ATM_activity_2', PPM1D(activity=u'active') + ATM(activity=u'active') >> PPM1D(activity=u'active') + ATM(activity=u'inactive'), kf_pa_act_1)
Rule(u'MDM2_deactivates_TP53_activity_2', MDM2(activity=u'active') + TP53(activity=u'active') >> MDM2(activity=u'active') + TP53(activity=u'inactive'), kf_mt_act_1)
...
Initial(ATM(activity='active'), ATMa_0)
...
Annotation(ATM_activates_ATM_activity_2, u'ATM', u'rule_has_subject')
Annotation(ATM_activates_ATM_activity_2, u'ATM', u'rule_has_object')
Annotation(ATM_activates_TP53_activity_2, u'ATM', u'rule_has_subject')
Annotation(ATM_activates_TP53_activity_2, u'TP53', u'rule_has_object')
Annotation(TP53_activates_PPM1D_activity_3, u'TP53', u'rule_has_subject')
Annotation(TP53_activates_PPM1D_activity_3, u'PPM1D', u'rule_has_object')
Annotation(TP53_activates_MDM2_activity_3, u'TP53', u'rule_has_subject')
Annotation(TP53_activates_MDM2_activity_3, u'MDM2', u'rule_has_object')
...
Annotation(PPM1D_deactivates_ATM_activity_2, u'PPM1D', u'rule_has_subject')
Annotation(PPM1D_deactivates_ATM_activity_2, u'ATM', u'rule_has_object')
Annotation(MDM2_deactivates_TP53_activity_2, u'MDM2', u'rule_has_subject')
Annotation(MDM2_deactivates_TP53_activity_2, u'TP53', u'rule_has_object')
