...
Rule(u'ATM_activates_ATM_activity', ATM() + ATM(activity=u'inactive') >> ATM() + ATM(activity=u'active'), kf_aa_act_1)
Rule(u'ATM_activates_TP53_activity', ATM() + TP53(activity=u'inactive') >> ATM() + TP53(activity=u'active'), kf_at_act_1)
